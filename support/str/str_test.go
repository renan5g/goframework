...
import (
	...
	"github.com/renan5g/goframework/support/env"
)
...
func (s *StringTestSuite) TestAfter() {
	s.Equal("Framework", Of("PagaiFramework").After("Pagai").String())
	...
	s.Equal("PagAi", Of("PagAi").After("").String())
}

func (s *StringTestSuite) TestAfterLast() {
	s.Equal("Framework", Of("PagaiFramework").AfterLast("Pagai").String())
...
func (s *StringTestSuite) TestBefore() {
	s.Equal("Pagai", Of("PagaiFramework").Before("Framework").String())
...
func (s *StringTestSuite) TestBeforeLast() {
	s.Equal("Pagai", Of("PagaiFramework").BeforeLast("Framework").String())
...
func (s *StringTestSuite) TestCamel() {
	s.Equal("pagaiGOFramework", Of("Pagai_g_o_framework").Camel().String())
	s.Equal("pagaiGOFramework", Of("Pagai_gO_framework").Camel().String())
	s.Equal("pagaiGoFramework", Of("Pagai -_- go -_-  framework  ").Camel().String())
...
func (s *StringTestSuite) TestKebab() {
	s.Equal("pagai-framework", Of("PagaiFramework").Kebab().String())
}
...
func (s *StringTestSuite) TestIsMatch() {
	...
	s.True(Of("Hello, Pagai!").IsMatch(`.*,.*!`))
	s.True(Of("Hello, Pagai!").IsMatch(`^.*$(.*)`))
	s.True(Of("Hello, Pagai!").IsMatch(`(?i)pagai`))
	s.True(Of("Hello, PAGai!").IsMatch(`^(.*(.*(.*)))`))

	// Test non-matching with a single pattern
	s.False(Of("Hello, Pagai!").IsMatch(`H.o`))
	s.False(Of("Hello, Pagai!").IsMatch(`^pagai!`))
	s.False(Of("Hello, Pagai!").IsMatch(`pagai!(.*)`))
	s.False(Of("Hello, Pagai!").IsMatch(`^[a-zA-Z,!]+$`))

	// Test with multiple patterns
	s.True(Of("Hello, Pagai!").IsMatch(`.*,.*!`, `H.o`))
	s.True(Of("Hello, Pagai!").IsMatch(`(?i)pagai`, `^.*$(.*)`))
	s.True(Of("Hello, Pagai!").IsMatch(`(?i)pagai`, `pagai!(.*)`))
	s.True(Of("Hello, Pagai!").IsMatch(`^[a-zA-Z,!]+$`, `^(.*(.*(.*)))`))
}

func (s *StringTestSuite) TestNewLine() {
	s.Equal("Pagai\n", Of("Pagai").NewLine().String())
	s.Equal("Pagai\n\nbar", Of("Pagai").NewLine(2).Append("bar").String())
}
...
func (s *StringTestSuite) TestPadLeft() {
	s.Equal("     Pagai", Of("Pagai").PadLeft(10, " ").String())
	s.Equal("====Pagai", Of("Pagai").PadLeft(9, "=").String())
	s.Equal("Pagai", Of("Pagai").PadLeft(3, " ").String())
}

func (s *StringTestSuite) TestPadRight() {
	s.Equal("Pagai     ", Of("Pagai").PadRight(10, " ").String())
	s.Equal("Pagai====", Of("Pagai").PadRight(9, "=").String())
	s.Equal("Pagai", Of("Pagai").PadRight(3, " ").String())
}
...
func (s *StringTestSuite) TestSnake() {
	s.Equal("pagai_g_o_framework", Of("PagaiGOFramework").Snake().String())
	s.Equal("pagai_go_framework", Of("PagaiGoFramework").Snake().String())
	s.Equal("pagai go framework", Of("PagaiGoFramework").Snake(" ").String())
	s.Equal("pagai_go_framework", Of("Pagai Go Framework").Snake().String())
	s.Equal("pagai_go_framework", Of("Pagai    Go      Framework   ").Snake().String())
	s.Equal("pagai__go__framework", Of("PagaiGoFramework").Snake("__").String())
...
func (s *StringTestSuite) TestStudly() {
	s.Equal("PagaiGOFramework", Of("Pagai_g_o_framework").Studly().String())
	s.Equal("PagaiGOFramework", Of("Pagai_gO_framework").Studly().String())
	s.Equal("PagaiGoFramework", Of("Pagai -_- go -_-  framework  ").Studly().String())
...
func (s *StringTestSuite) TestUcFirst() {
	...
	s.Equal("Framework", Of("Framework").UcFirst().String())
	s.Equal(" framework", Of(" framework").UcFirst().String())
	s.Equal("Pagai framework", Of("pagai framework").UcFirst().String())
}

func (s *StringTestSuite) TestUcSplit() {
	s.Equal([]string{"Krishan", "Kumar"}, Of("KrishanKumar").UcSplit())
	s.Equal([]string{"Hello", "From", "Pagai"}, Of("HelloFromPagai").UcSplit())
...
func (s *StringTestSuite) TestWordCount() {
	...
	s.Equal(10, Of("Hi, this is my first contribution to the Pagai framework.").WordCount())
}
...
func TestCase2Camel(t *testing.T) {
	assert.Equal(t, "PagaiFramework", Case2Camel("pagai_framework"))
	assert.Equal(t, "PagaiFramework1", Case2Camel("pagai_framework1"))
	assert.Equal(t, "PagaiFramework", Case2Camel("PagaiFramework"))
}

func TestCamel2Case(t *testing.T) {
	assert.Equal(t, "pagai_framework", Camel2Case("PagaiFramework"))
	assert.Equal(t, "pagai_framework1", Camel2Case("PagaiFramework1"))
	assert.Equal(t, "pagai_framework", Camel2Case("pagai_framework"))
}
