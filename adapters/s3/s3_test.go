...
import (
	...
	contractsfilesystem "github.com/renan5g/goframework/contracts/filesystem"
...
func TestStorage(t *testing.T) {
	...
	assert.Nil(t, os.WriteFile("test.txt", []byte("Goframework"), 0644))
	...
	tests := []struct {
	...
	}{
		{
			name: "AllDirectories",
			setup: func() {
				assert.Nil(t, driver.Put("AllDirectories/1.txt", "Goframework"))
				assert.Nil(t, driver.Put("AllDirectories/2.txt", "Goframework"))
				assert.Nil(t, driver.Put("AllDirectories/3/3.txt", "Goframework"))
				assert.Nil(t, driver.Put("AllDirectories/3/5/6/6.txt", "Goframework"))
		...
		},
		{
			name: "AllFiles",
			setup: func() {
				assert.Nil(t, driver.Put("AllFiles/1.txt", "Goframework"))
				assert.Nil(t, driver.Put("AllFiles/2.txt", "Goframework"))
				assert.Nil(t, driver.Put("AllFiles/3/3.txt", "Goframework"))
				assert.Nil(t, driver.Put("AllFiles/3/4/4.txt", "Goframework"))
		...
		},
		{
			name: "Copy",
			setup: func() {
				assert.Nil(t, driver.Put("Copy/1.txt", "Goframework"))
		...
		},
		{
			name: "Delete",
			setup: func() {
				assert.Nil(t, driver.Put("Delete/1.txt", "Goframework"))
		...
		},
		{
			...
			setup: func() {
				assert.Nil(t, driver.Put("DeleteDirectory/1.txt", "Goframework"))
		...
		},
		{
			name: "Directories",
			setup: func() {
				assert.Nil(t, driver.Put("Directories/1.txt", "Goframework"))
				assert.Nil(t, driver.Put("Directories/2.txt", "Goframework"))
				assert.Nil(t, driver.Put("Directories/3/3.txt", "Goframework"))
				assert.Nil(t, driver.Put("Directories/3/5/5.txt", "Goframework"))
		...
		},
		{
			name: "Files",
			setup: func() {
				assert.Nil(t, driver.Put("Files/1.txt", "Goframework"))
				assert.Nil(t, driver.Put("Files/2.txt", "Goframework"))
				assert.Nil(t, driver.Put("Files/3/3.txt", "Goframework"))
				assert.Nil(t, driver.Put("Files/3/4/4.txt", "Goframework"))
		...
		},
		{
			name: "Get",
			setup: func() {
				assert.Nil(t, driver.Put("Get/1.txt", "Goframework"))
				assert.True(t, driver.Exists("Get/1.txt"))
				data, err := driver.Get("Get/1.txt")
				assert.Nil(t, err)
				assert.Equal(t, "Goframework", data)
		...
		},
		{
			name: "GetBytes",
			setup: func() {
				assert.Nil(t, driver.Put("GetBytes/1.txt", "Goframework"))
				assert.True(t, driver.Exists("GetBytes/1.txt"))
				data, err := driver.GetBytes("GetBytes/1.txt")
				assert.Nil(t, err)
				assert.Equal(t, []byte("Goframework"), data)
		...
		},
		{
			name: "LastModified",
			setup: func() {
				assert.Nil(t, driver.Put("LastModified/1.txt", "Goframework"))
		...
		},
		{
			name: "MimeType",
			setup: func() {
				assert.Nil(t, driver.Put("MimeType/1.txt", "Goframework"))
		...
		},
		{
			name: "Move",
			setup: func() {
				assert.Nil(t, driver.Put("Move/1.txt", "Goframework"))
		...
		},
		{
			name: "Put",
			setup: func() {
				assert.Nil(t, driver.Put("Put/1.txt", "Goframework"))
		...
		},
		{
			name: "Size",
			setup: func() {
				assert.Nil(t, driver.Put("Size/1.txt", "Goframework"))
		...
		},
		{
			name: "TemporaryUrl",
			setup: func() {
				assert.Nil(t, driver.Put("TemporaryUrl/1.txt", "Goframework"))
				...
				assert.Nil(t, err)
				assert.Equal(t, "Goframework", string(content))
		...
		},
		{
			name: "Url",
			setup: func() {
				assert.Nil(t, driver.Put("Url/1.txt", "Goframework"))
