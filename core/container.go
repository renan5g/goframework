...
import (
	...
	"github.com/renan5g/goframework/config"
	"github.com/renan5g/goframework/console"
	"github.com/renan5g/goframework/filesystem"
	"github.com/renan5g/goframework/http"
	"github.com/renan5g/goframework/log"
	"github.com/renan5g/goframework/route"
	"github.com/renan5g/goframework/translation"
	"github.com/renan5g/goframework/validation"

	cachecontract "github.com/renan5g/goframework/contracts/cache"
	...
	logcontract "github.com/renan5g/goframework/contracts/log"
	routecontract "github.com/renan5g/goframework/contracts/route"
	translationcontract "github.com/renan5g/goframework/contracts/translation"
	validationcontract "github.com/renan5g/goframework/contracts/validation"
)
...
func (c *Container) Bind(key any, callback func(app corecontract.Application) (any, error)) {
	c.bindings.Store(key, instance{concrete: callback, shared: false})
}

func (c *Container) BindWith(key any, callback func(app corecontract.Application, parameters map[string]any) (any, error)) {
	c.bindings.Store(key, instance{concrete: callback, shared: false})
}
...
func (c *Container) Singleton(key any, callback func(app corecontract.Application) (any, error)) {
...
func (c *Container) make(key any, parameters map[string]any) (any, error) {
	...
	case func(app corecontract.Application) (any, error):
	...
	case func(app corecontract.Application, parameters map[string]any) (any, error):
