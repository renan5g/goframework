...
import (
	...
	"github.com/renan5g/goframework/core/console"
...
func (app *Application) getBaseServiceProviders() []core.ServiceProvider {
...
func (app *Application) getConfiguredServiceProviders() []core.ServiceProvider {
	return app.MakeConfig().Get("app.providers").([]core.ServiceProvider)
}
...
func (app *Application) registerServiceProviders(serviceProviders []core.ServiceProvider) {
...
func (app *Application) bootServiceProviders(serviceProviders []core.ServiceProvider) {
	for _, serviceProvider := range serviceProviders {
