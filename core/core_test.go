...
import (
	...
	"github.com/renan5g/goframework/console"
	...
	"github.com/renan5g/goframework/validation"
	"github.com/stretchr/testify/assert"
	"github.com/stretchr/testify/suite"

	frameworkconfig "github.com/renan5g/goframework/config"
	frameworktranslation "github.com/renan5g/goframework/translation"

	// "github.com/renan5g/goframework/auth"
	"github.com/renan5g/goframework/cache"
	// frameworkconfig "github.com/renan5g/goframework/config"
	// "github.com/renan5g/goframework/console"
	// "github.com/renan5g/goframework/contracts/database/orm"

	// "github.com/renan5g/goframework/crypt"
	// "github.com/renan5g/goframework/database"
	// "github.com/renan5g/goframework/database/gorm"
	// "github.com/renan5g/goframework/event"
	"github.com/renan5g/goframework/filesystem"
	// "github.com/renan5g/goframework/grpc"
	// "github.com/renan5g/goframework/hash"
	"github.com/renan5g/goframework/http"
	frameworklog "github.com/renan5g/goframework/log"

	// "github.com/renan5g/goframework/mail"

	configmocks "github.com/renan5g/goframework/mocks/config"
	routemocks "github.com/renan5g/goframework/mocks/route"

	// ormmocks "github.com/renan5g/goframework/mocks/database/orm"
	logmocks "github.com/renan5g/goframework/mocks/log"
	// queuemocks "github.com/renan5g/goframework/mocks/queue"
	// routemocks "github.com/renan5g/goframework/mocks/route"
	// "github.com/renan5g/goframework/queue"
	// "github.com/renan5g/goframework/schedule"
	// supportdocker "github.com/renan5g/goframework/support/docker"
...
func (s *ApplicationTestSuite) TestPath() {
	s.Equal(filepath.Join("internal", "goravel.go"), s.app.Path("goravel.go"))
}
...
// 	s.app.Singleton(frameworkconfig.Binding, func(app core.Application) (any, error) {
// 		return mockConfig, nil
// 	})
// 	s.app.Singleton(cache.Binding, func(app core.Application) (any, error) {
// 		return &cachemocks.Cache{}, nil
// 	})
// 	s.app.Singleton(database.BindingOrm, func(app core.Application) (any, error) {
...
func (s *ApplicationTestSuite) TestMakeCache() {
	...
	s.app.Singleton(frameworklog.Binding, func(app core.Application) (any, error) {
...
// 	s.app.Singleton(queue.Binding, func(app core.Application) (any, error) {
...
func (s *ApplicationTestSuite) TestMakeRoute() {
	...
	s.app.Singleton("goravel.route", func(app core.Application) (any, error) {
...
// 	s.app.Singleton(console.Binding, func(app core.Application) (any, error) {
